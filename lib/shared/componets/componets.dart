                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              SizedBox(width: 10),
                              Text(
                                "${DateFormat.yMMMd('fr').format(DateTime.parse(task.date.toString().split(' ').first))}",
                                style: TextStyle(
                          ...
                          Row(
                            children: [
                              ...
                              Text(
                                ...
                                "${DateFormat("HH:mm").format(DateTime.parse("2022-10-10 " + task.starttime.toString())).toString()} - ${DateFormat("HH:mm").format(DateTime.parse("2022-10-10 " + task.endtime.toString())).toString()}",
                                style: TextStyle(
                                    fontSize: 15, color: Colors.white),
                              ),
                            ],
