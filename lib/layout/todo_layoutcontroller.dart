...
class TodoLayoutController extends GetxController {
  ...
  List<BottomNavigationBarItem> bottomItems = [
    BottomNavigationBarItem(icon: Icon(Icons.menu), label: "Événements"),
    BottomNavigationBarItem(
        icon: Icon(Icons.check_circle_outline), label: "Terminé"),
    BottomNavigationBarItem(
  ...
  final appbar_title = ["Événements", "Terminés", "Archives"];
